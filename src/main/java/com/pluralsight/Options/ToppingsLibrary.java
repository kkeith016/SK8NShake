...
public class ToppingsLibrary {
    ...
    public static List<Topping> getAllToppings() {
        return List.of(
                ...
                new Topping("BBQ Sauce", "Sauce", "Basic", 0.0, List.of("Sandwich", "Pizza")),
                new Topping("Ranch", "Sauce", "Basic", 0.0, List.of("Sandwich", "Pizza")),
                ...
                new Topping("Chocolate Syrup", "Sweet Sauce", "Basic", 0.0, List.of("Milkshake")),
